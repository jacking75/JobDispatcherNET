...
- **구현 상태**: A절(A1~A12)·B절(B1~B6) 적용 완료, C절은 C1·C2·C3·C5·C6 적용(2026-09-03).
  **C4(intrusive MPSC 큐)는 측정 결과 근거가 없어 보류** — 1 생산자 구간에서 `ConcurrentQueue` 대비
  개선이 재현되지 않고 런마다 부호가 뒤집힌다. 측정치와 판단 근거는 `docs/benchmarks.md`에 기록.
